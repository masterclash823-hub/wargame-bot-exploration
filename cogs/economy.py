...
HELP_SECTIONS = {
    ...
    "combat": {
        ...
        "fields": [
            ...
            ("/treaty marriage treaty_id", "Propose or accept an adult dynastic marriage in an active alliance."),
            ("/treaty outcome", "Declare a winner in a peace proposal; the other party must accept the outcome and captive terms."),
            ("/exploration [preparations] [expedition_id]", "Free-text expedition. After three replies, shorter scenes lead toward the conclusion. The final outcome appears in the original channel with a GM ping."),
            ...
            ("/event list [nation]", "View events without flags, up to 15 per page; blank = your nation."),
...
GM_HELP_FIELDS = [
    ...
    ("/event all [description]", "Prepare missing event drafts for all playable nations; optional shared theme. Review and publish with /event post."),
    ...
    ("/event post <id> [visibility] [channel] [image_query] [include_image] [file]", "Start an event with an illustration from search or your file. Disable include_image to skip illustrations."),
    ("/event image <event_id> [image_query] [file] [message_link]", "Retry an event illustration or upload JPG/PNG/WebP. Repairs the public post without resetting decisions."),
...
HELP_SECTIONS_PL = {
    ...
    "combat": {
        ...
        "fields": [
            ...
            ("/treaty marriage treaty_id", "Zaproponuj lub zaakceptuj mariaż dorosłych postaci w aktywnym sojuszu."),
            ("/treaty outcome", "Wskaż zwycięzcę w propozycji pokoju; druga strona zatwierdza wynik i warunek jeńców."),
            ("/exploration [preparations] [expedition_id]", "Opisowa wyprawa. Po trzeciej odpowiedzi krótsze sceny prowadzą do finału. Wynik trafia na pierwotny kanał z pingiem GM."),
            ...
            ("/event list [naród]", "Lista eventów bez flag, do 15 na stronę; puste = własne państwo."),
...
GM_HELP_FIELDS_PL = [
    ...
    ("/event all [opis]", "Przygotuj brakujące szkice eventów dla wszystkich grywalnych państw; opcjonalny wspólny temat. Sprawdź i opublikuj przez /event post."),
    ...
    ("/event post <id> [visibility] [channel] [image_query] [include_image] [file]", "Rozpocznij event z ilustracją z wyszukiwarki lub pliku. Wyłącz include_image, aby pominąć obrazek."),
    ("/event image <event_id> [image_query] [file] [message_link]", "Ponów szukanie ilustracji lub wgraj JPG/PNG/WebP. Naprawia publiczny post bez resetowania decyzji."),
