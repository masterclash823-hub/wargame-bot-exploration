...
GM_HELP_FIELDS = [
    ...
    ("/event post <id> [visibility] [channel] [image_query]", "Start a private (default) or public event. Decisions stay private."),
...
GM_HELP_FIELDS_PL = [
    ...
    ("/event post <id> [visibility] [channel] [image_query]", "Rozpocznij event prywatny (domyślnie) lub publiczny. Decyzje pozostają prywatne."),
